...
class FourndyOCGeneratorSpace {
  ...
  randomGeneratedOC() {
    ...
    return pronounChoice
      ? `${pronounChoice.pronoun.charAt(0).toUpperCase() + pronounChoice.pronoun.slice(1)} is ${name}, ${pronounChoice.possessive} age is ${age}. ${pronounChoice.pronoun.charAt(0).toUpperCase() + pronounChoice.pronoun.slice(1)} is a ${species} and works as a ${occupation}. With ${pronounChoice.possessive} ${hairColor} hair, a ${personality} personality, and a skill in ${skill}, ${name} wields a ${weapon}. Sexuality: ${sexuality}.`
